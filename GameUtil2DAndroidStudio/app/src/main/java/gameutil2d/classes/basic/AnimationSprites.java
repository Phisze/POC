...
/*
 *  [AnimationSprites.java]  - Classe destinada para exibição de animações de sprites na tela do jogo
 * 
...
public class AnimationSprites extends GameElement{
    ...
    public void Draw(SpriteBatcher spriteBatcher) {
    	...
    	aImage.get(index_image).Draw(spriteBatcher);
    ...
    public void Draw(SpriteBatcher spriteBatcher, FlipEffect effect) {
    	...
    	if(effect == FlipEffect.NONE)
    	 ...
    	 aImage.get(index_image).Draw(spriteBatcher,FlipEffect.HORIZONTAL);
